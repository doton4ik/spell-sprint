...
function words(library: string, topic: string, values: Array<[string, string, LibraryWord['difficulty'], number, string?, string?, string?]>): LibraryWord[] {
  return values.map(([word, translation, difficulty, risk, rule, example, partOfSpeech]) => ({
    id: `${library}-${word}`.toLowerCase().replaceAll(' ', '-'), wordId: `${library}-${word}`.toLowerCase().replaceAll(' ', '-'), word, translation,
    topicId: topic.toLowerCase().replaceAll(/[^a-z0-9]+/g, '-'), topic, subtopic: '', difficulty, risk, rule, example,
    partOfSpeech: partOfSpeech ?? '', library, source: 'built-in',
  }))
}

export const builtInLibraries: WordLibrary[] = [
  { id: 'logistics-core', name: 'Logistics Core', topic: 'Logistics', source: 'built-in', words: words('Logistics Core', 'Logistics', [
  ...
  { id: 'business-core', name: 'Business Essentials', topic: 'Business and Office', source: 'built-in', words: words('Business Essentials', 'Business and Office', [
  ...
  { id: 'general-active', name: 'General English: Active Vocabulary', topic: 'General English', source: 'built-in', words: words('General English: Active Vocabulary', 'General English', [
  ...
  { id: 'study-career', name: 'Study & Career', topic: 'Study and Career', source: 'built-in', words: words('Study & Career', 'Study and Career', [
  ...
  { id: 'travel', name: 'Travel Essentials', topic: 'Travel and Culture', source: 'built-in', words: words('Travel Essentials', 'Travel and Culture', [
  ...
  { id: 'sap-logistics', name: 'SAP / Professional Logistics', topic: 'Warehouse Operations', source: 'built-in', words: words('SAP / Professional Logistics', 'Warehouse Operations', [
  ...
  { id: 'sports', name: 'Sports', topic: 'Sport and Fitness', source: 'built-in', words: words('Sports', 'Sport and Fitness', [
